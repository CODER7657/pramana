...
class BenchReport:
    ...
    def render(self) -> str:
        ...
        add("  end-to-end in a reproduction held pending coordinated")
        add("  disclosure (see SECURITY.md). The gap between the two columns")
        add("  is a real property of that implementation.")
        add("")
